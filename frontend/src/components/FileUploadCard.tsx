  ...
  return (
    ...
    >
      ...
      >
        {/* 渐变边框效果 */}
        <div
          className={`absolute inset-0 rounded-2xl p-[2px] bg-gradient-to-r from-primary-200 via-primary-300 to-primary-200 -z-10
            ${dragOver ? 'from-primary-500 via-primary-400 to-primary-500' : ''}`}
        >
