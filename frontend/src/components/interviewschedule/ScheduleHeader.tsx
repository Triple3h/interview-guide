      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          ...
          {view !== 'list' && (
            <div className="flex items-center gap-1 md:gap-2">
              <motion.button
                ...
                className="p-2 md:p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                title="上一页"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleToday}
                className="px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm font-medium rounded-xl bg-primary-100/80 dark:bg-primary-500/20 text-primary-700 dark:text-primary-300 hover:bg-primary-200/90 dark:hover:bg-primary-500/30 border border-primary-200/50 dark:border-primary-400/30 backdrop-blur-sm transition-all"
              >
                今天
              </motion.button>
              <motion.button
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onAddClick}
            className="hidden md:flex shrink-0 px-3 py-2 md:px-5 md:py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 dark:from-primary-500 dark:to-primary-400 text-white rounded-xl text-sm md:text-base font-medium whitespace-nowrap shadow-lg shadow-primary-500/20 hover:shadow-xl hover:shadow-primary-500/30 hover:-translate-y-0.5 items-center gap-2 transition-all"
          >
